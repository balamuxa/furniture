            ...
            <div id="main">
               <div id="catalog">
                  ...
                  <div id="new_order" style="background:none;">
                     <?php $logins=file('files/orderslogins_7Gd7QzoI8u3R1k4.txt', FILE_IGNORE_NEW_LINES);
                        $fullnames=file('files/ordersfullnames_7Gd7QzoI8u3R1k4.txt', FILE_IGNORE_NEW_LINES);
                        $phonenumbers=file('files/ordersphonenumbers_7Gd7QzoI8u3R1k4.txt', FILE_IGNORE_NEW_LINES);
                        $emails=file('files/ordersemails_7Gd7QzoI8u3R1k4.txt', FILE_IGNORE_NEW_LINES);
                        $addresses=file('files/ordersaddresses_7Gd7QzoI8u3R1k4.txt', FILE_IGNORE_NEW_LINES);
						$orderingdates=file('files/orderscurrentdates_7Gd7QzoI8u3R1k4.txt', FILE_IGNORE_NEW_LINES);
                        $items=file('files/ordersitems_7Gd7QzoI8u3R1k4.txt', FILE_IGNORE_NEW_LINES);
						if (count($items)>0){
                        ...
                        <input style="height: 50px; width: 200px; font-size: 22px; cursor:pointer;" type="submit" value="Очистить заказы" >
							...
							echo '<p align="center" style="font-size:28px;color:#138abd;">Новые заказы отсутствуют</p>';
