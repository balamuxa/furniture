                        ...
                        if (isset($_SESSION['login']) && isset($_SESSION['adminmode'])) {
                           ...
                           echo '
                              ...
                              <form action="confirmordering.php" method="get">
								 ...
								 <option value="Магазин на ул.Красный проспект 88">Магазин на ул.Красный проспект 88</option>
								 <option value="Магазин на ул.Ватутина 37">Магазин на ул.Ватутина 37</option>
								 </select><br><br>
                                 </td>
                                 </tr>
                                 <tr>
